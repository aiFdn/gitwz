...
const rulesPrompts: {
    ...
    'body-empty': (applicable: string) => llmReadableRules.emptyRule('body', applicable, undefined),
    'body-full-stop': (applicable: string, value: string) => llmReadableRules.fullStopRule('body', applicable, value),
    'body-leading-blank': (applicable: string) => llmReadableRules.blankline('body', applicable, undefined),
    ...
    'footer-empty': (applicable: string) => llmReadableRules.emptyRule('footer', applicable, undefined),
    'footer-leading-blank': (applicable: string) => llmReadableRules.blankline('footer', applicable, undefined),
    ...
    'references-empty': (applicable: string) => llmReadableRules.emptyRule('references section', applicable, undefined),
    'scope-case': (applicable: string, value: string | Array<string>) =>
        llmReadableRules.caseRule('scope', applicable, value),
    'scope-empty': (applicable: string) => llmReadableRules.emptyRule('scope', applicable, undefined),
    ...
    'subject-empty': (applicable: string) => llmReadableRules.emptyRule('subject', applicable, undefined),
    ...
    'type-empty': (applicable: string) => llmReadableRules.emptyRule('type', applicable, undefined),
...
const getPrompt = (ruleName: string, ruleConfig: RuleConfigTuple<unknown>, prompt: DeepPartial<PromptConfig>) => {
...
export const inferPromptsFromCommitlintConfig = (config: QualifiedConfig): string[] => {
